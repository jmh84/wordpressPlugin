...
class KlabBaseFunctionalities_CustomPostTypeConstructor
{
     ...
     * Uses the default args + labels + rewrite slug
     * @param string $post_type_name gives the name for
    ...
    public function initiateUsingDefaultArgs ($post_type_name, $slug, $labels)
    {
